...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        ComboBox1.Items.AddRange(New Object() {"iphone", "Samsung", "Huawei", "ZTE"})
        ComboBox1.Location = New Point(238, 95)
        ...
        ' Button1
        ' 
        Button1.Location = New Point(33, 208)
        ...
        ' Button2
        ' 
        Button2.Location = New Point(198, 208)
